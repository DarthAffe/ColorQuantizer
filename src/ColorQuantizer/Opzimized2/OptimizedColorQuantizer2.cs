...
{
    public class OptimizedColorQuantizer2 /*: IColorQuantizer*/
    {
        /// <inheritdoc />
        public SKColor[] Quantize(in Span<SKColor> colors, int amount)
        {
            ...
            SKColor[] sortArray = ArrayPool<SKColor>.Shared.Rent(512 * 1024);

            Queue<ColorCube> cubes = new(amount);
            cubes.Enqueue(new ColorCube(colors, 0, colors.Length, sortArray, SortTarget.None));
            ...
            ArrayPool<SKColor>.Shared.Return(sortArray);
